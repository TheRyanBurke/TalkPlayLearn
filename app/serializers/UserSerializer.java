...
public class UserSerializer implements JsonSerializer<User> {
	...
	public JsonElement serialize(User arg0, Type arg1,
		...
		Gson gson = new GsonBuilder().registerTypeAdapter(EngagedQuest.class,
				new EngagedQuestSerializer()).create();
		...
		jso.add("xpToLevelPercent",
				new JsonPrimitive(100 * arg0.xp / arg0.currentLevelXPCap()));
